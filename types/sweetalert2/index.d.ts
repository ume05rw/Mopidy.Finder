// Admin-LTEプラグインフォルダには無かったが、オリジナルGitHubページにあった。
// モジュール宣言されていたため、クラス＋名前空間宣言に書き換えた。
// https://github.com/sweetalert2/sweetalert2/blob/master/sweetalert2.d.ts
/**
...
declare class Swal {
     ...
     */
    static fire(title: string, message?: string, type?: Swal.SweetAlertType): Promise<Swal.SweetAlertResult>;
    /**
     ...
     *   })
     */
    static fire(settings: Swal.SweetAlertOptions): Promise<Swal.SweetAlertResult>;

    fire(settings: Swal.SweetAlertOptions): Promise<Swal.SweetAlertResult>;
    ...
    /**
        ...
        */
    static mixin(options?: Swal.SweetAlertOptions): Swal;
     ...
     *   })
     */
    update(newSettings: Swal.SweetAlertOptions): void;
     ...
     */
    eclose(onComplete?: (modalElement: HTMLElement) => void): void;
     ...
     */
    queue(steps: Array<Swal.SweetAlertOptions | string>): Promise<any>;
     ...
     */
    insertQueueStep(step: Swal.SweetAlertOptions, index?: number): number;
     ...
     */
    argsToParams(params: Swal.SweetAlertArrayOptions | [Swal.SweetAlertOptions]): Swal.SweetAlertOptions;
}
